...
#### Узел №5
Для получения оценки узла 5 не надо проводить редукцию, так как в каждой строке и в каждом столбце матрицы есть хотя бы один 0, следовательно сумма констант редукции: 0

Оценка узла 5 = 31 + 0  = 31
